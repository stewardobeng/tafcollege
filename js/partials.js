(function () {
    ...
    var footerFallback = '<div class="container-fluid bg-dark text-light footer py-5 wow fadeIn" data-wow-delay="0.1s">' +
        '<div class="footer-stripes" aria-hidden="true">' +
        '<span class="footer-stripe footer-stripe-1"></span>' +
        '<span class="footer-stripe footer-stripe-2"></span>' +
        '<span class="footer-stripe footer-stripe-3"></span>' +
        '</div>' +
